...
| goodix_sensor_fp_enroll_verify     | C2EC        | yes                           | CMP X2, X1  |
| goodix_sensor_fp_enroll_verify     | C2F0        | yes                           | CMP X2, X1  |
| goodix_sensor_fp_enroll_verify     | C2F4        | yes                           | CMP X2, X1  |
| goodix_sensor_fp_enroll_verify     | C2F8        | yes                           | CMP X2, X1  |
| goodix_sensor_fp_enroll_verify     | C300        | yes                           | CMP X2, X1  |
| goodix_sensor_fp_set_user_id       | C200        | yes                           | CMP X2, X1  |
| goodix_sensor_fp_set_user_id       | C204        | yes                           | CMP X2, X1  |
| goodix_sensor_fp_set_user_id       | C208        | yes                           | CMP X2, X1  |
| goodix_sensor_fp_set_user_id       | C20C        | yes                           | CMP X2, X1  |
| goodix_sensor_fp_set_user_id       | C214        | yes                           | CMP X2, X1  |
| goodix_enable_screen_lock          | D1C0        | yes                           | CMP X2, X1  |
| goodix_enable_screen_lock          | D1C4        | yes                           | CMP X2, X1  |
| goodix_enable_screen_lock          | D1C8        | yes                           | CMP X2, X1  |
| goodix_enable_screen_lock          | D1CC        | yes                           | CMP X2, X1  |
| goodix_enable_screen_lock          | D1D4        | yes                           | CMP X2, X1  |
| goodix_disable_screen_lock         | D29C        | yes                           | CMP X2, X1  |
| goodix_disable_screen_lock         | D2A0        | yes                           | CMP X2, X1  |
| goodix_disable_screen_lock         | D2A4        | yes                           | CMP X2, X1  |
